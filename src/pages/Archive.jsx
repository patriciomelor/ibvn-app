  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-slate-400 text-sm">Cargando archivo histórico...</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold font-display text-white tracking-tight">Archivo Histórico</h2>
          <p className="text-slate-400 text-sm mt-1">Busca y repasa devocionales y tu diario de vida espiritual.</p>
        </div>
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-900 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition-all text-sm"
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredDevocionales.length === 0 ? (
          <div className="glass rounded-3xl p-8 text-center border border-slate-800">
            <p className="text-slate-400 text-sm">No se encontraron devocionales que coincidan con la búsqueda.</p>
          </div>
        ) : (
            ...
            return (
              <div
                ...
                className={`glass rounded-2xl overflow-hidden border transition-all duration-200 ${
                  isExpanded ? 'border-indigo-500/30 shadow-lg' : 'border-slate-850 hover:border-slate-750'
                }`}
              >
                {/* Cabecera del Item */}
                <button
                ...
                {/* Contenido Expandido */}
                {isExpanded && (
                  <div className="px-6 pb-6 pt-2 border-t border-slate-800/50 bg-slate-900/20 space-y-6 animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      <div className="lg:col-span-2 space-y-4">
                        <div>
                          ...
                          <p className="text-slate-300 text-sm leading-relaxed text-justify whitespace-pre-line">
                            {dev.reflexion}
                          </p>
                        </div>
                      ...
                      <div className="bg-slate-900/50 border border-slate-800/60 rounded-xl p-5">
                        <h5 className="font-bold font-display text-white text-sm mb-4 border-b border-slate-800 pb-2">
                        ...
                        {loadingJournal ? (
                          ...
                          <div className="space-y-3.5 text-xs">
                            ...
                            <div>
                              ...
                              <p className="text-slate-300 leading-relaxed bg-slate-950/40 p-2.5 rounded-lg border border-slate-850 italic">
